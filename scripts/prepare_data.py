...
def prepare(
    ...
    test_split_fraction: Optional[float] = 0.03865,  # to get exactly 2000 test samples,
    seed: int = 42,
    mask_inputs: bool = False,  # as in alpaca-lora
    data_file_name: str = "alpaca_data_cleaned_archive.json",
    data_file_name_val: Optional[str] = None,
    ...
    if not data_file_name_val:
        ...
        train_set = data
        with open(data_file_name_val, "r", encoding="utf-8") as val_file:
            test_set = json.load(val_file)
